...
@section('content')
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold float-left text-primary"><strong>{{$page->title}} makalesini güncelle</strong></h6>
        </div>
        <div class="card-body">
            @if($errors->any())
            ...
            <form method="POST" action="{{route('admin.page.edit.post',$page->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <img src="{{asset($page->image)}}" width="300" class="form-group rounded img-thumbnail">
